...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 21, 2025 at 08:31 PM
...
(34, 'table', 'Table tennis', 'Ping Pong', 'pongpong@gmail.com', '09897866543', 'Admin', 'Te7xsyY3xqXYYmzQMlvw/aaLB4xELHHHfNhPhMel6bw=', 'Pending', 'N/A', 'N/A', 'N/A', 'src/userimages/laravel link.png'),
...
--
ALTER TABLE `logs`
  MODIFY `log_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=410;
...
--
ALTER TABLE `product`
  MODIFY `p_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `user`
--
ALTER TABLE `user`
  MODIFY `u_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
