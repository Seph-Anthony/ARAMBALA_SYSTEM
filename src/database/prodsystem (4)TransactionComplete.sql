...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 01, 2025 at 09:58 PM
...
(1, 30, 15, 1, 200, 300, 100, 'Pending', '2025-04-02');
...
(2, 'Noodles', 'Food and Beverage', 'Lucky Me', 25, 22, 'Available', ''),
...
(8, 'Shoes', 'Food and Beverage', 'Nike', 50, 25, 'Available', ''),
(9, 'Shoes', 'Personal Wellness', 'Nike', 500, 11, 'Available', ''),
(10, 'Wrench', 'Supplies Utilities', 'Mr Tool', 40, 20, 'Available', ''),
...
(15, 'Hammer', 'Supplies Utilities', 'Saving Tools', 200, 4, 'Available', 'src/userimages/Screenshot 2025-03-07 224221.png');
...
(34, 'table', 'Table tennis', 'Ping Pong', 'pongpong@gmail.com', '09897866543', 'Employee', 'c8ppu2gSTqlup+HZn/I43uq6TVRhhcU/fOEjaLM3+uo=', 'Active', 'N/A', 'N/A', 'N/A', 'src/userimages/laravel link.png'),
...
--
ALTER TABLE `logs`
  MODIFY `log_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=208;
