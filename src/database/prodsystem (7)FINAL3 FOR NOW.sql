...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 24, 2025 at 11:02 PM
...
(8, 30, 8, 5, 250, 500, 250, 'Pending', '2025-04-25');
...
(8, 'Shoes', 'Food and Beverage', 'Nike', 50, 19, 'Available', ''),
...
--
ALTER TABLE `logs`
  MODIFY `log_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=556;
